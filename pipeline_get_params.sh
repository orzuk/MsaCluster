...
sbatch -o $OUTPUT_NAME_DIR/RunAF.out  ./Pipeline/RunAF_params.sh $OUTPUT_NAME_DIR
#mkdir -p ./Pipeline/output/esm_fold_output
#sbatch -o $OUTPUT_NAME_DIR/ESMFold.out ./Pipeline/RunEsmFold.sh
mkdir -p ./Pipeline/$OUTPUT_NAME_DIR/output_cmap_esm
sbatch -o $OUTPUT_NAME_DIR/CmapESM.out  ./CmapESM_params.sh $OUTPUT_NAME_DIR
