...
def getESM(args):
    msas_folder = '/Users/steveabecassis/PycharmProjects/AF_Cluster/output/'
...
#
#     class args:
#         o = '/Users/steveabecassis/Desktop/Kaib/esm/'
#         input_msas = [msas_folder+'/'+msa for msa in os.listdir(msas_folder) if 'a3m' in str(msa)]
#         # model = 'esm1b'
#         model = 'msa_t'
#         keyword = 'ESM'
#         test = False
